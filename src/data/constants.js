import Bazar from '../assets/e-bazar-products.png'
import Mindpixel from '../assets/mindpixel.png'
...
export const Bio = {
  ...
  github: "https://github.com/surya9520",
  resume:
...
export const skills = [
  ...
  },
  {
    ...
    skills: [
      ...
      {
        name: "Mongoose",
        image: "https://pbs.twimg.com/profile_images/946432748276740096/0TXzZU7W_400x400.jpg",
      },
    ],
  },
  {
...
export const projects = [
  {
    ...
    description:
    "MindPixel is a dynamic social networking platform that captures the essence of visual storytelling. Just like Instagram, MindPixel allows users to seamlessly share their life moments through captivating images and engage with a growing community of friends and like-minded individuals.On MindPixel, you can create and customize your profile, follow friends and discover new connections, and share your creativity through image posts. Show your appreciation for the moments that resonate with you by liking and leaving thoughtful comments on posts.With a user-friendly interface and a focus on fostering genuine connections, MindPixel is your go-to destination for visual expression and building meaningful relationships in the digital age.",
    image:
   Mindpixel,
    tags: [
      "React Js",
  ...
  {    id: 9,
    ...
    description:
    "e-bazar is a MERN e-commerce app that revolutionizes online shopping. With an intuitive user interface driven by Redux, Material-UI, and Tailwind CSS, it offers a seamless shopping experience. In addition to features like product ratings, e-bazar allows users to chat directly with sellers, ensuring personalized interactions and trustworthy purchases. This versatile platform also includes an admin section for effortless product and event management. Shoppers can easily add products to their cart, favorite items, and enjoy secure, hassle-free checkout with Stripe as the payment gateway. Discover the ultimate solution for an unparalleled online shopping journey.",
    image:
     Bazar,
    tags: [
      "React Js",
    ...
    category: "web app",
    github: "https://github.com/surya9520/e-bazar1.git",
    webapp: "https://e-bazar1-uyvz.vercel.app/",
  }
];
